defmodule JSONSuite do
  def test_suite do
    [
      ...
      # {"n_object_pi_in_key_and_trailing_comma.json", {:error, nil}},
      ...
      # {"y_object_escaped_null_in_key.json", {:ok, %{"foo\NULbar" => 42}}},
      ...
      # {"y_string_accepted_surrogate_pair.json", {:ok, ["\xD801\xdc37"]}},
      # {"y_string_accepted_surrogate_pairs.json", {:ok, ["\xd83d\xde39\xd83d\xdc8d"]}},
      ...
      # {"y_string_escaped_control_character.json", {:ok, ["\DC2"]}},
      # {"y_string_escaped_noncharacter.json", {:ok, ["\xFFFF"]}},
      {"y_string_in_array.json", {:ok, ["asd"]}},
      {"y_string_in_array_with_leading_space.json", {:ok, ["asd"]}},
      # {"y_string_last_surrogates_1_and_2.json", {:ok, ["\xDBFF\xDFFF"]}},
      # {"y_string_nbsp_uescaped.json", {:ok, ["new\x00A0line"]}},
      # {"y_string_nonCharacterInUTF-8_U+10FFFF.json", {:ok, ["\x10FFFF"]}},
      # {"y_string_nonCharacterInUTF-8_U+1FFFF.json", {:ok, ["\x1BFFF"]}},
      # {"y_string_nonCharacterInUTF-8_U+FFFF.json", {:ok, ["\xFFFF"]}},
      # {"y_string_null_escape.json", {:ok, ["\NUL"]}},
      # {"y_string_one-byte-utf-8.json", {:ok, [","]}},
      {"y_string_pi.json", {:ok, ["π"]}},
      {"y_string_simple_ascii.json", {:ok, ["asd "]}},
      {"y_string_space.json", {:ok, " "}},
      # {"y_string_surrogates_U+1D11E_MUSICAL_SYMBOL_G_CLEF.json", {:ok, ["\xD834\xDd1e"]}},
      # {"y_string_three-byte-utf-8.json", {:ok, ["\x0821"]}},
      # {"y_string_two-byte-utf-8.json", {:ok, ["\x0123"]}},
      # {"y_string_u+2028_line_sep.json", {:ok, ["\x2028"]}},
      # {"y_string_u+2029_par_sep.json", {:ok, ["\x2029"]}},
      # {"y_string_uEscape.json", {:ok, ["aクリス"]}},
      # {"y_string_uescaped_newline.json", {:ok, ["new\nline"]}},
      {"y_string_unescaped_char_delete.json", {:ok, ["\d"]}},
      # {"y_string_unicode.json", {:ok, ["\xA66D"]}},
      # {"y_string_unicodeEscapedBackslash.json", {:ok, ["\\"]}},
      {"y_string_unicode_2.json", {:ok, ["⍂㈴⍂"]}},
      # {"y_string_unicode_escaped_double_quote.json", {:ok, ["\""]}},
      # {"y_string_unicode_U+10FFFE_nonchar.json", {:ok, ["\xDBFF\xDFFE"]}},
      # {"y_string_unicode_U+1FFFE_nonchar.json", {:ok, ["\xD83F\xDFFE"]}},
      # {"y_string_unicode_U+200B_ZERO_WIDTH_SPACE.json", {:ok, ["\x200B"]}},
      # {"y_string_unicode_U+2064_invisible_plus.json", {:ok, ["\x2064"]}},
      # {"y_string_unicode_U+FDD0_nonchar.json", {:ok, ["\xFDD0"]}},
      # {"y_string_unicode_U+FFFE_nonchar.json", {:ok, ["\xFFFE"]}},
